...
public class PublicController {
    ...
    public String homePage(Model model) {
        try {
            ...
            List<Watch> newestProducts = watchService.findLatestWatches(8);
    ...
    private String getPriceRangeLabel(String priceRange) {
        switch (priceRange) {
            case "under-1m": return "Dưới 1 triệu";
            case "1m-3m": return "1 - 3 triệu";
            case "3m-5m": return "3 - 5 triệu";
            case "5m-10m": return "5 - 10 triệu";
            case "over-10m": return "Trên 10 triệu";
