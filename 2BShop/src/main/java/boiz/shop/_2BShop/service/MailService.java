...
public class MailService {
     ...
     */
    public void sendOrderConfirmation(boiz.shop._2BShop.entity.Order order, java.util.List<boiz.shop._2BShop.entity.OrderDetail> orderDetails) {
        ...
        // Format ngày
        String orderDate = order.getOrderDate().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm"));
        ...
        for (boiz.shop._2BShop.entity.OrderDetail detail : orderDetails) {
            ...
            productsHtml.append("<tr style='border-bottom: 1px solid #e0e0e0;'>")
                ...
                .append("</div>")
                .append("<div>")
                .append("<div style='font-weight: 600; color: #1a1a1a; margin-bottom: 5px;'>").append(watch.getWatchName()).append("</div>")
                .append("<div style='font-size: 12px; color: #666; margin-bottom: 3px;'>Mã SP: <strong>").append(watchCode).append("</strong></div>")
                .append("<div style='font-size: 12px; color: #666;'>Thương hiệu: <strong>").append(watch.getBrand().getBrandName()).append("</strong></div>");
        ...
        String body = "<!DOCTYPE html>" +
            ...
            // Content
            "<div class='content'>" +
            "<p style='font-size: 15px; color: #333; margin-bottom: 20px;'>Xin chào <strong>" + customerName + "</strong>,</p>" +
            ...
            "<span style='font-weight: 600;'>" + (shippingFee.compareTo(java.math.BigDecimal.ZERO) == 0 ? "Miễn phí" : String.format("%,d₫", shippingFee.longValue())) + "</span>" +
            "</div>" +
            ...
            "<p style='margin: 5px 0; font-size: 14px; color: #333;'><strong>Người nhận:</strong> " + order.getReceiverName() + "</p>" +
            "<p style='margin: 5px 0; font-size: 14px; color: #333;'><strong>Số điện thoại:</strong> " + order.getShippingPhone() + "</p>" +
            "<p style='margin: 5px 0; font-size: 14px; color: #333;'><strong>Địa chỉ:</strong> " + order.getShippingAddress() + "</p>" +
            (order.getNotes() != null && !order.getNotes().isEmpty() ? 
                "<p style='margin: 5px 0; font-size: 14px; color: #333;'><strong>Ghi chú:</strong> " + order.getNotes() + "</p>" : "") +
            "</div>" +
